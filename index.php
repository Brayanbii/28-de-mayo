...
try {
    ...
    // Seleccionamos la base de datos y la colección correspondientes
    $db = $cliente->prueba;	
    $coleccion = $db->gustos;	

    // Consulta para listar los documentos ordenados por fecha de registro (más recientes primero)
...
<head>
    ...
    <title>SENA Multiverse Atlas - Portal de Héroes</title>
    <!-- Bootstrap 5 CSS CDN -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Iconos de Bootstrap -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css" rel="stylesheet">
    <!-- Google Fonts para toque cinematográfico e infantil/heroico -->
    <link href="https://fonts.googleapis.com/css2?family=Bangers&family=Luckiest+Guy&family=Montserrat:wght@400;700;900&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        .search-input-giant::placeholder {
...
<body>
    ...
    <div class="container pt-5 pb-5">
        ...
        <div class="row g-5">
            ...
            <!-- COLUMNA DERECHA: SECCIÓN DE PERSONAS REGISTRADAS -->
            <div class="col-lg-7">
                
                <!-- Cabecera de la lista de Héroes -->
                <div class="d-flex justify-content-between align-items-center mb-4 border-bottom border-secondary pb-3" style="position: relative; z-index:2;">
                    <h2 class="multiverse-grid-title m-0 text-start">
                        <i class="bi bi-people-fill me-2 text-info"></i>Personas Registradas
                    </h2>
                ...
                <div class="search-box-container shadow">
                    <div class="d-flex align-items-center mb-2">
                        <i class="bi bi-search text-warning fs-4 me-2"></i>
                        <span class="fw-bold text-uppercase tracking-wide text-warning" style="font-size: 0.9rem;">Buscador Multiversal de Espectadores</span>
                    </div>
                    <input type="text" id="multiverseSearch" class="form-control search-input-giant" placeholder="Escribe el nombre o apellido para filtrar...">
                    <small class="text-white-50 mt-2 d-block"><i class="bi bi-info-circle-fill me-1"></i> Esta sección filtra dinámicamente las tarjetas de abajo al instante.</small>
                </div>

                <div class="row row-cols-1 row-cols-md-2 g-4" id="heroesContainer">
                    <?php 
                    ...
                    ?>
                            <div class="col hero-card-wrapper" data-searchable="<?= mb_strtolower(($doc['apellidos'] ?? '') . ' ' . ($doc['nombres'] ?? '')) ?>">
                                <div class="character-card">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <span class="badge bg-dark border border-warning text-warning px-3 py-2 font-monospace">VIP PASS</span>
                                    </div>
    ...
    <script>
        document.getElementById('multiverseSearch').addEventListener('input', function(e) {
            const query = e.target.value.toLowerCase().trim();
            const cards = document.querySelectorAll('.hero-card-wrapper');
            
            cards.forEach(card => {
                const searchData = card.getAttribute('data-searchable');
